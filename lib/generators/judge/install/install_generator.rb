module Judge
  module Generators
    class InstallGenerator < ::Rails::Generators::Base
      ...
      desc %Q{For use in Rails 3.0 apps or more recent apps with asset pipeline disabled.
...
Copy judge.js to different path:
  $ rails generate judge:install path/to/javascript/dir

Copy judge.js and dependencies:
  $ rails generate judge:install --underscore --json2
}
      ...
      def exec
        unless ::Rails.version < "3.1" || !::Rails.application.config.assets.enabled
